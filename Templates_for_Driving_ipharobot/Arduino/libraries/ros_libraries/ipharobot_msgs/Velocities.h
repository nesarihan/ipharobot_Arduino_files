#ifndef _ROS_ipharobot_msgs_Velocities_h
#define _ROS_ipharobot_msgs_Velocities_h
...
namespace ipharobot_msgs
{
  ...
  class Velocities : public ros::Msg
  {
    ...
    const char * getType(){ return "ipharobot_msgs/Velocities"; };
