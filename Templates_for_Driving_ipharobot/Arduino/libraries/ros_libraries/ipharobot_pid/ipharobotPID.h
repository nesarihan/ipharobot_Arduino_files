#ifndef _ROS_ipharobot_pid_ipharobotPID_h
#define _ROS_ipharobot_pid_ipharobotPID_h
...
namespace lino_pid
{
  ...
  class ipharobotPID : public ros::Msg
  {
    public:
      float p;
      float d;
    ...
    const char * getType(){ return "ipharobot_pid/ipharobotPID"; };
